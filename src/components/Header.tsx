...
const Header = () => {
  ...
  return (
    <header className={`w-full z-50 transition-all duration-300 py-2 lg:py-0  ${
      isScrolled ? 'bg-white/95 backdrop-blur-md border-b-2  fixed top-0 ' : 'bg-[#023657]'
    }`}>
      <div className="bg-white hidden lg:block"><TopBar /></div>
      <div className="px-6 py-4 lg:px-20">
